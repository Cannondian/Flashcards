...
### App Description
`TODO://` An app that allows you to make flashcards, scroll through them, and flip the card to see the answer.

### App Walk-though
![](https://i.imgur.com/6YVrWsK.gif)
![](https://i.imgur.com/bje0KGE.gif)
